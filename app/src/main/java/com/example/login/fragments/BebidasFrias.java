...
public class BebidasFrias extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mContext=getContext();
        View vista=inflater.inflate(R.layout.fragment_bebidas_frias, container, false);
        ...
        dbr.child("menu").child("Bebidas Frias").addValueEventListener(new ValueEventListener() {
            @Override
